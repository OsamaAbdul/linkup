...
export function DashboardSidebar({ activeTab, setTab, pendingOrdersCount = 0, openIssuesCount = 0, transactions = [], wallet }: DashboardSidebarProps) {
    ...
    return (
        <>
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-black/5 h-16 px-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-xl bg-primary flex items-center justify-center text-white shrink-0">
                        <LayoutDashboard size={16} />
                    </div>
                    <h2 className="font-black text-base sm:text-lg tracking-tight truncate hidden xs:block">Seller Dashboard</h2>
                </div>
                ...
                <Sheet>
                    ...
                    <SheetContent side="left" className="w-[280px] p-6 flex flex-col no-scrollbar overflow-y-auto">
                        <SheetHeader className="text-left mb-8">
                            <SheetTitle className="flex items-center gap-3 font-black tracking-tight">
            ...
            <div className="lg:hidden fixed bottom-6 left-4 right-4 z-50 flex items-center justify-around bg-white/90 backdrop-blur-2xl border border-black/5 h-16 rounded-xl shadow-up-2xl p-2 max-w-md mx-auto">
