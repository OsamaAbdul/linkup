...
export default function AdminIssueManager() {
    ...
    if (issuesLoading) return (
        <div className="p-20 text-center bg-white rounded-[3rem] shadow-sm animate-pulse">
            ...
            <p className="font-black text-xl uppercase tracking-widest text-primary/40">Synchronizing Support Feed...</p>
        </div>
    );
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col gap-1">
                <h2 className="text-3xl font-black tracking-tight">Security & Resolution Feed</h2>
                <p className="text-muted-foreground font-medium">Real-time surveillance of marketplace anomalies and buyer disputes.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {issues?.length === 0 ? (
                    <div className="col-span-full p-20 text-center bg-white rounded-[3rem] border-2 border-dashed border-gray-100 shadow-sm">
                        ...
                        <h3 className="font-black text-2xl mb-2">Neutral Zone</h3>
