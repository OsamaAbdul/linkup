import { Bell, MapPin, User, LogOut, Package, CreditCard, Search, ShoppingCart, MessageSquare, Send, Wallet } from "lucide-react";
            ...
            <>
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64 glass border-white/10 rounded-xl p-2 mt-4 shadow-2xl">
                  ...
                  <Link to="/wallet">
                    <DropdownMenuItem className="cursor-pointer rounded-xl py-3 px-3 focus:bg-emerald-50 focus:text-emerald-700">
                      <Wallet className="mr-3 h-4 w-4 text-emerald-600" />
