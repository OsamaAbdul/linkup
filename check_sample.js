...
async function check() {
    const { data: profiles } = await supabase.from("profiles").select("id, user_id, display_name").limit(10);
    process.stdout.write("Profiles Sample: " + JSON.stringify(profiles, null, 2) + "\n");
}
check();
